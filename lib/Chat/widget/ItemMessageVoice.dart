...
class ItemMessageVoice extends StatelessWidget {
  ...
  const ItemMessageVoice({Key key, this.messageData, this.isMe = false, this.message, this.isStep = false, this.textColor}) : super(key: key);
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              child: AudioPlayerWidget(file:messageData.fileName,onPlay:(w){
              },myAudio: MyAudio(
                name: 'Online',
                audio: Audio.network(messageData.fileName),),
              ),
            ),
            Row(
