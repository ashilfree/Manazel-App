...
class FlutterLocalNotificationsPlugin {
  ...
  static Future<dynamic> getIntent()async{
    return await MethodChannelFlutterLocalNotificationsPlugin.getNotificationIntent();
  }

  static Future<dynamic> remove_intent()async{
    return await MethodChannelFlutterLocalNotificationsPlugin.remove_intent();
  }
